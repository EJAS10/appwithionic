...
@Component({
  selector: 'app-mapa-integration',
  templateUrl: './mapa-integration.page.html',
  styleUrls: ['./mapa-integration.page.scss'],
})
export class MapaIntegrationPage implements OnInit {
  map: GoogleMap;
  loading: any;
